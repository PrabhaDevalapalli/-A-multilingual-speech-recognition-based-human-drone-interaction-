...
DATASET_PATH = '/content/drive/MyDrive/mini_speech_commands/mini_speech_commands'
...
# Example usage:
audio_path = '/content/drive/MyDrive/audio test files/hello1.wav'
predicted_label = predict_audio(audio_path, model)
print('Predicted Label:', predicted_label)

audio_path = '/content/drive/MyDrive/audio test files/right.wav'
predicted_label = predict_audio(audio_path, model)
print('Predicted Label:', predicted_label)

audio_path = '/content/drive/MyDrive/audio test files/yes.wav'
predicted_label = predict_audio(audio_path, model)
print('Predicted Label:', predicted_label)
